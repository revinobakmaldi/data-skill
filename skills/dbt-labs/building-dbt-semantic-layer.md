...
source_path: skills/dbt/skills/building-dbt-semantic-layer/SKILL.md
source_url: https://github.com/dbt-labs/dbt-agent-skills/blob/main/skills/dbt/skills/building-dbt-semantic-layer/SKILL.md
license: Apache-2.0
---
